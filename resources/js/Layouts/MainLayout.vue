...
import { faCalendar, faHome, faPerson } from '@fortawesome/free-solid-svg-icons';
...
const menuItemsData : Ref<MenuItemInterface[]>=ref([
    { label: 'Dashboard', icon: faHome,route:route('dashboard'), count: null },
    {label:'Users',icon:faPerson,route:route('users.index') ,count:3},
    {label:'Sections',icon:faScreenpal,route:route('sections.index') ,count:null},
    {label:'Holidays',icon:faCalendar,route:'#',count:null},
])
