...
defineProps<{
    menuItemsData:MenuItemInterface[]
}>()
...
<template>
<div class="w-64 z-50 absolute shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out bg-white"
            id="mobile-nav">
            ...
            <div class="px-8">
                ...
                <ul class="mt-12">
                    <MobileMenuItem :menus='menuItemsData' />
                </ul>
            </div>
        </div>
</template>
